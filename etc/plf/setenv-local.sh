...
# eXo Addon JMXTrans
[ -z $EXO_JMXTRANS_ADDON_HOST ] && EXO_JMXTRANS_ADDON_HOST="${DEPLOYMENT_JMXTRANS_ADDON_HOST}"
[ -z $EXO_JMXTRANS_ADDON_PORT ] && EXO_JMXTRANS_ADDON_PORT="${DEPLOYMENT_JMXTRANS_ADDON_PORT}"
[ -z $EXO_JMXTRANS_CATEGORY ] && EXO_JMXTRANS_CATEGORY="${DEPLOYMENT_JMXTRANS_CATEGORY}"
